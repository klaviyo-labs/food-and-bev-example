...
export declare class ProfilePropertyDateTrigger {
    'type': DateEnum | 'date';
...
export declare namespace ProfilePropertyDateTrigger {
    enum TimedeltaUnitBeforeDateEnum {
        Days,
        Months,
        Weeks
    }
